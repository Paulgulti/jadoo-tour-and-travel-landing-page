...
const Header = () => {
    ...
    return (
        <nav className='border border-red-500 container h-[40px] mt-[37px] mx-auto flex items-center justify-between px-4'>
            <h1 className='text-[#181E4B] font-medium text-[44px]'>Jadoo</h1>
            {/* <div className='absolute bg-orange-300 min-h-[60vh] left-0 top-[77px]'>
            </div> */}
                <ul className='hidden md:flex flex-col md:flex-row items-center md:gap-5 lg:gap-13 text-[17px] font-sans'>
                ...
                <div className='hidden md:flex flex-col md:flex-row lg:gap-5 md:gap-3'>
