...
const Footer = () => {
    return (
        <div className='mb-5  w-[1114px] mx-auto font-poppins'>
            <div className=' flex gap-10 '>
                ...
                <div>
                    <h4 className='text-[21px] text-black font-bold mb-2.5'>Useful Links</h4>
                    <ul>
                ...
                <div>
                    <h4 className='text-[21px] text-black font-bold mb-2.5'>Contact Us</h4>
                    <ul>
                ...
                <div>
                    <h4 className='text-[21px] text-black font-bold mb-2.5'>More</h4>
                    <ul>
                ...
                <div>
                    <h4 className='text-[21px] text-black font-bold mb-2.5'>Follow Us</h4>
